...
class GujratAccountAdmin(admin.ModelAdmin):
   list_display = ['Date', 'VIA', 'Truck_Number', 'Truck_Company', 'Total_CTN', 'To_Pay', 'Truck_Rent', 'Karachi_Transit_Rent', 'Lahore_Transit_Rent' ,'Payment_Date','Amount']
...
class MultanAccountAdmin(admin.ModelAdmin):
   list_display = ['Date', 'VIA', 'Truck_Number', 'Truck_Company', 'Total_CTN', 'To_Pay', 'Truck_Rent', 'Karachi_Transit_Rent','Payment_Date','Amount']
...
class FaislabadJhungAccountAdmin(admin.ModelAdmin):
   list_display = ['Date', 'VIA', 'Truck_Number', 'Truck_Company', 'Total_CTN', 'To_Pay', 'Truck_Rent', 'Karachi_Transit_Rent', 'Lahore_Transit_Rent', 'FSD_to_Jhung_Transit_Rent','Payment_Date','Amount']
...
class GujranwalaAccountAdmin(admin.ModelAdmin):
   list_display = ['Date', 'VIA', 'Truck_Number', 'Truck_Company', 'Total_CTN', 'To_Pay', 'Truck_Rent', 'Karachi_Transit_Rent', 'Lahore_Transit_Rent','Rawalpindi_Transit_Rent','Payment_Date','Amount']
